...
public interface Fichas
{
    public static Normal crearFichas(int fila,int columna,int posX,int posY,String jugador,boolean king,int tipo){
        ...
        switch(tipo){
            case 1:
            ficha=new Normal(fila,columna,posX,posY,jugador,king);
            break;
            case 2:
            ficha= new libertarian(fila,columna,posX,posY,jugador,king);
            break;
            case 3:
            ficha= new powerFull(fila,columna,posX,posY,jugador,king);
        }
        return ficha;       
    }
